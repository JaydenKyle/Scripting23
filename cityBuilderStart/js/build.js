...
document.getElementById('city').innerHTML="You Have "+buildings+"In your City";
...
function buildOne(){
    ...
    buildings++;
    document.getElementById('city').innerHTML="You Have "+buildings+" In your City";
    document.getElementById('cityGraphic').innerHTML+= "<img src='images/BuildingBlock1.png' alt='building1'>";
...
function buildTwo(){
    ...
    buildings++;
    document.getElementById('city').innerHTML="You Have "+buildings+" In your City";
    document.getElementById('cityGraphic').innerHTML+= "<img src='images/BuildingBlock2.png' alt='building2'>";
...
function buildThree(){
    ...
    buildings++;
    document.getElementById('city').innerHTML="You Have "+buildings+" In your City";
    document.getElementById('cityGraphic').innerHTML+= "<img src='images/BuildingBlock3.png' alt='building3'>";
...
function buildFour(){
    ...
    buildings++;
    document.getElementById('city').innerHTML="You Have "+buildings+" In your City";
    document.getElementById('cityGraphic').innerHTML+= "<img src='images/BuildingBlock4.png' alt='building4'>";
