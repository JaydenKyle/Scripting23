...
console.log("My favourite is "+animal+"!");
...
document.getElementById('column1').innerHTML="<h3>I changed the page!</h3>";
document.getElementById('column1').innerHTML+="<p>Woah I can keep Adding More</p>";
document.getElementById('column1').innerHTML+="<p>I can keep adding and adding</p>";
document.getElementById('column1').innerHTML+="<img class=img-fluid src='images/code.jpg'alt='man holding a note saying code'>";
...
if(weapon=="Fire"){
    console.log("You got Fire");
}else if (weapon=="Spikes"){
    console.log("You got Spikes");
}else{
